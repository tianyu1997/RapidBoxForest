...
bool intervals_contain_point_pybind(const std::vector<rbf::Interval>& intervals,
...
bool interval_boxes_connected_pybind(const std::vector<rbf::Interval>& lhs,
...
std::vector<Eigen::VectorXd> densify_path_pybind(const std::vector<Eigen::VectorXd>& waypoints,
                                                 double step) {
...
PYBIND11_MODULE(_sbf_cpp, module) {
    ...
    py::class_<rbf::AdaptiveLeafSweepConfig>(module, "AdaptiveLeafSweepConfig")
        ...
        .def_readwrite("hipac_online_ffb_portal_fallback", &rbf::AdaptiveLeafSweepConfig::hipac_online_ffb_portal_fallback)
        ...
        .def_readwrite("hipac_online_transition_portal", &rbf::AdaptiveLeafSweepConfig::hipac_online_transition_portal)
        .def_readwrite("hipac_transition_target_query_indices", &rbf::AdaptiveLeafSweepConfig::hipac_transition_target_query_indices)
        .def_readwrite("hipac_transition_max_attempts_per_query", &rbf::AdaptiveLeafSweepConfig::hipac_transition_max_attempts_per_query)
        .def_readwrite("hipac_transition_candidate_limit", &rbf::AdaptiveLeafSweepConfig::hipac_transition_candidate_limit)
