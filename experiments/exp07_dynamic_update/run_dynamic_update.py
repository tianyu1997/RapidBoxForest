...
from safe_box_forest.experiments.sbf_old import common_scene_sampling as scene_sampling  # noqa: E402


sbf = exp04.sbf
DEFAULT_OUT = REPO_ROOT / "outputs" / "new_experiments" / "exp07_dynamic_update"
DEFAULT_TABLE = REPO_ROOT / "paper" / "sbf_old" / "generated" / "tab_tro_dynamic_rebuild.tex"
...
def ensure_scenes(args: argparse.Namespace, seeds: list[int], robot: Any) -> dict[int, dict[str, Any]]:
    scenes = {} if args.regenerate_scenes else read_scene_artifact(args.scenes_out)
    missing = [
