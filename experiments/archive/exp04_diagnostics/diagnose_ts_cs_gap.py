...
from experiments.archive.exp04_diagnostics.study_ts_cs_box_cover import (
    box_contains,
    build_forest,
    densify,
    dist,
        ...
        json.dumps(
            {
                ...
                "boundary_ffb_calls": debug.get("boundary_ffb_calls"),
                "boundary_commits": debug.get("boundary_commits"),
                "boundary_reject_not_free": debug.get("boundary_reject_not_free"),
                "boundary_reject_non_adjacent": debug.get("boundary_reject_non_adjacent"),
                "boundary_stall": debug.get("boundary_stall"),
                "boundary_target_hits": debug.get("boundary_target_hits"),
                "all_box_count": len(all_boxes),
                "committed_box_count": len(committed_boxes),
                "sample_count": len(sample_rows),
                "uncovered_all_count": sum(1 for row in sample_rows if not row["covered_all"]),
