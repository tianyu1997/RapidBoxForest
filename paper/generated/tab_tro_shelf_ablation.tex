...
\begingroup
\centering
\captionof{table}{Shelf+IIWA \rbf{} operating point and mechanism ablations that solve all saved queries.}
...
\end{tabular}
\par\vspace{0.1ex}
{\scriptsize\emph{Notes:} Median \([Q_1,Q_3]\), s. Amort. 5q is Build/5 + \onlineq{}; \onlineq{} excludes final simplification and audit.\par}
\par\endgroup
