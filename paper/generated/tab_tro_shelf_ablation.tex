...
\begingroup
\centering
\captionof{table}{Shelf+IIWA \rbf{} d23 baseline and profile controls}
...
\begin{tabular}{@{}lcccc@{}}
\toprule
Case & Build & Batch-task diag. & Diag.\ 5q & $L_q/L_{\mathrm{ref},q}$ \\
\midrule
...
\end{tabular}
\par\vspace{0.1ex}
{\footnotesize\emph{Notes:} Seconds; medians [25\%, 75\%]; b100, 8 seeds. Batch task: 40 within-batch timestamps, not single-query latency; ratios: matching audits. Baseline: IFK-AA+d23+Link-AABB+SupportHull/GJK\@. Diag.\ 5q \(=\mathrm{Build}/5+\mathrm{Batch\ task}\).\par}
\par\endgroup
