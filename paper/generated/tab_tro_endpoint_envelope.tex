...
\par\vspace{0.1ex}
{\footnotesize\emph{Notes:} 1000 boxes/width; medians; volume/Analytical. Gap is the negative largest per-axis width shortfall to the per-box reference extent hull; more negative is worse. Only IFK-AA/HIFK are candidates for the theoretical conservative branch.\par}
\par\endgroup
