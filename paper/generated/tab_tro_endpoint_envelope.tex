...
\par\vspace{0.1ex}
{\footnotesize\emph{Notes:} 1000 shared boxes/width; medians; volume/Analytical. Monte Carlo uses \(\operatorname{round}[(50000/0.35)w]\) samples/box (2857--71429). Gap is worst extent-width shortfall; -- is unreported. IFK-AA/HIFK are certificate-capable under the stated conditions.\par}
\par\endgroup
